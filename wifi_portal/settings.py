...
env = environ.Env(
    ...
    PORTAL_BRAND_NAME=(str, "Kingfield Hotel"),
    PORTAL_LOGO_URL=(str, ""),
    PORTAL_PRIMARY_COLOR=(str, "#0b6b61"),
    PORTAL_SUCCESS_MESSAGE=(str, "You are connected. You can now continue browsing."),
    PORTAL_SUPPORT_TEXT=(str, "Need help? Please contact reception."),
    PORTAL_TAGLINE=(str, "Guest Wi-Fi"),
...
PORTAL_PRIMARY_COLOR = env("PORTAL_PRIMARY_COLOR")
PORTAL_SUPPORT_TEXT = env("PORTAL_SUPPORT_TEXT")
PORTAL_SUCCESS_MESSAGE = env("PORTAL_SUCCESS_MESSAGE")
PORTAL_TAGLINE = env("PORTAL_TAGLINE")
